...
$result = $obj_product->select_product_info_by_id($product_id);
$product_info = mysqli_fetch_assoc($result);
if(isset($_POST['update'])){
    $obj_product->update_product_info($_POST,$_FILES);
}
?>
            ...
            <form class="form-horizontal" name="edit_product" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" name="product_price" value="<?php echo $product_info['product_price'];?>" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Product Quantity </label>
                        <div class="controls">
                            <input type="number" name="product_quantity" value="<?php echo $product_info['product_quantity'];?>" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Product Code </label>
                        <div class="controls">
                            <input type="text" name="product_size" value="<?php echo $product_info['product_size'];?>" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4">
                        </div>
                    </div>
                    <div class="control-group">
...
<script type="text/javascript">
    ...
    document.forms['edit_product'].elements['menufacturer_id'].value='<?php echo $product_info['menufacturer_id']?>';
