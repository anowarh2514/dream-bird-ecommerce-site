...
<section class="breadcrumbs">
    <div class="container">
        <ul class="horizontal_list clearfix bc_list f_size_medium">
            ...
            <li><a href="#" class="default_t_color">Compare Products</a></li>
        </ul>
    </div>
</section>
<!--content-->
<div class="page_content_offset">
    <div class="container">
        ...
        <table class="table_type_2 responsive_table type_2 full_width r_corners wraper shadow t_align_l m_bottom_30">
            <tr>
                ...
                <td data-title="Product Image,Name &amp; Category">
                    <img class="m_bottom_10" src="./asset/front_end/images/quick_view_img_10.jpg" alt=""><br>
                ...
                <td data-title="Product Image,Name &amp; Category">
                    <img class="m_bottom_10" src="./asset/front_end/images/wishlist_img_1.jpg" alt=""><br>
                    <a href="#" class="fw_medium d_inline_b f_size_ex_large color_dark m_bottom_5">Eget elementum vel</a><br>
                    <a href="#" class="default_t_color">Dresses</a>
                </td>
                <td data-title="Product Image,Name &amp; Category">
                    <img class="m_bottom_10" src="./asset/front_end/images/wishlist_img_3.jpg" alt=""><br>
                    <a href="#" class="fw_medium d_inline_b f_size_ex_large color_dark m_bottom_5">Eget elementum vel</a><br>
                    <a href="#" class="default_t_color">Dresses</a>
                </td>
            </tr>
        ...
        <a href="index.php" role="button" class="d_inline_b bg_light_color_2 color_dark tr_all_hover button_type_4 r_corners"><i class="fa fa-reply m_left_5 m_right_10 f_size_large"></i>Back to: Shop home</a>
    </div>
</div>